...
Q_DECL_CONSTEXPR char ALIAS_OBJECT_NAME[] = "UltraNoteClassicWallet";
Q_DECL_CONSTEXPR char ALIAS_NAME_TAG[] = "UltraNoteClassicWallet";
Q_DECL_CONSTEXPR char ALIAS_ADDRESS_TAG[] = "XUN";
